...
\begin{quote}
[Author]. Shape-Height Transform for DNA: Mathematical Framework and Comprehensive Validation of Three Orthogonal Geometric Units. Technical Monograph, 2026.
\end{quote}

And provide the Zenodo DOI for version specificity.
