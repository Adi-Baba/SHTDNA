...
\begin{keyresult}
    \begin{enumerate}
        ...
        \item Vij and Mamton exhibit strong coupling ($r = 0.87$, $p < 10^{-60}$, $N=200$)
        \item Four distinct geometric states exist in the structural database
        \item Geometric signatures predict functional class with $81\%$ accuracy (stratified CV; $79\%$ OOB)
